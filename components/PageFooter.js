	...
	getDefaultHtml() {
		...
		<footer>
			<div class="footer-content">
				<a href="/index.html">
					<img src="/images/logos/bell_logo.png" alt="TowerBells Logo" width="100px" />
				</a>

				<ul>
					<li>
						<a href="/pages/SearchTowerBells.html">Search</a>
					</li>
					<li>
						<a href="/pages/WebsiteMap.html">Site Map</a>
					</li>
					<li>
						<a href="/pages/Introduction/CSZ.html">About</a>
					</li>
					<li>
