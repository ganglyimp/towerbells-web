				...
				<div class="footer-links">
					<div>
						<a href="${this.pagePath}/SearchTowerBells.html">
							...
							<br>
							<b>Search the Entire Website</b>
						</a>
					</div>

					<div>
						<a href="${this.pagePath}/WebsiteMap.html">
							<!-- Map Icon -->
					...
					<div>
						<a href="${this.pagePath}/Essays/UnrelatedEssays.html">
							<!-- Book Icon -->
							...
							<br>
							<b>Unrelated Essays</b>
						</a>
					</div>

					<div>
						<a href="${this.pagePath}/Introduction/CSZ.html">
							<!-- Person Circle Icon -->
